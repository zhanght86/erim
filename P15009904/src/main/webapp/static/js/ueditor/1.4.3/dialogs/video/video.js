...
(function(){
        ...
        for (var i = 0; i < tabs.length; i++) {
            domUtils.on(tabs[i], "click", function (e) {
                ...
                for (j = 0; j < tabs.length; j++) {
                    ...
                    if(tabs[j] == target){
                        domUtils.addClass(tabs[j], 'fozy');
                        domUtils.addClass($G(bodyId), 'fozy');
                    }else {
                        domUtils.removeClasses(tabs[j], 'fozy');
                        domUtils.removeClasses($G(bodyId), 'fozy');
                    }
                }
            });
        }
    ...
    function addOkListener(){
        dialog.onok = function(){
            $G("preview").innerHTML = "";
            var currentTab =  findFozy("tabHeads","tabSrc");
            switch(currentTab){
                case "video":
                    return insertSingle();
                    break;
    ...
    function insertSingle(){
        var width = $G("videoWidth"),
            ...
            align = findFozy("videoFloat","name");
        if(!url) return false;
    ...
    /**
     * 找到id下具有fozy类的节点并返回该节点下的某个属性
     * @param id
     * @param returnProperty
     */
    function findFozy( id, returnProperty ) {
     ...
     function createAlignButton( ids ) {
         for ( var i = 0, ci; ci = ids[i++]; ) {
             ...
             for ( var j in nameMaps ) {
                 ...
                 if ( j == "none" ) div.className="fozy";
                 div.style.cssText = "background:url(images/" + j + "_fozy.jpg);";
    ...
    function insertUpload(){
        var videoObjs=[],
            ...
            align = findFozy("upload_alignment","name") || 'none';
