...
/**
 * @ClassName: VtextarrayAbImg 
 * @Description: 行程安排行程改为图片
 * @author maoxian
 * @date 2015年12月2日 下午2:03:11
 */
public class VtextarrayAbImg extends Directive {
	...
	public String getValueByCode(String code,String parentcode){
		...
		for(CodeBean c : listCode){
			...
			if(cod.equals(code)){
				retValue = c.getCodeMark();
			}
		}
		return PropertiesUtils.getPropertyByKey("app.staticFileTemplate") + retValue;
	}
}
