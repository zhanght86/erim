package com.erim.sz.data.service;
...
import com.erim.sz.data.dao.SellSystemTeamDao;
...
public class SellSystemTeamService {
	 ...
	 * @throws
	 */
	public List<SellSystemTeamBean> selectPageData(SellSystemTeamBean bean,ModelMap map){
		List<SellSystemTeamBean> list=sellSystemTeamDao.selectPageData(bean,map);
