...
public class GuideDetailDao extends BaseDao {
	 ...
	 * @throws
	 */
	public void updateGuide(GuideDetailBean bean) {
		getSqlSession().update("guidedetail.update", bean);
	}
	 ...
	 * @throws
	 */
	public void deleteguide(GuideDetailBean bean) {
		getSqlSession().update("guidedetail.deletebean", bean);
	}
