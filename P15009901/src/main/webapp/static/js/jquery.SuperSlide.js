...
jQuery.extend(jQuery.easing, {
 ...
 /*酒店详情和酒店预订之间的转换*/
 $('.hlxqct_cttop li').click(function(){
        var liindex = $('.hlxqct_cttop li').index(this);
        $(this).addClass('hlxqct_cttoplihover').siblings().removeClass('hlxqct_cttoplihover');
        $('.hlxqct_ctct div.hlxqct_ctctc').eq(liindex).fadeIn(150).siblings('.hlxqct_ctct div.hlxqct_ctctc').hide();
    });
