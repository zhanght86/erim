...
SWFUpload.prototype.initSWFUpload = function (settings) {
	try {
		this.zytomSettings = {};	// A container where developers can place their own settings associated with this instance.
...
SWFUpload.prototype.initSettings = function () {
	...
	this.ensureDefault("zytom_settings", {});

	// Other settings
	this.zytomSettings = this.settings.zytom_settings;
...
SWFUpload.prototype.displayDebugInfo = function () {
	this.debug(
		[
			...
			"\t", "zytom_settings:          ", this.settings.zytom_settings.toString(), "\n",
			"Event Handlers:\n",
...
// Use the swfupload_loaded_handler event setting to execute zytom code when SWFUpload has loaded.
...
SWFUpload.Console.writeLine = function (message) {
	...
	try {
		...
		wxcalert("Exception: " + ex.name + " Message: " + ex.message);
	}
};
		...
		onDialogClose :  function(filesSelected, filesQueued, queueLength) {
			...
			if ($.inArray('onDialogClose', settings.overrideEvents) < 0) {
				if (this.queueData.filesErrored > 0) {
					wxcalert(this.queueData.errorMsg);
				}
			}
		...
		onUploadError : function(file, errorCode, errorMsg) {
			...
			switch(errorCode) {
				...
				case SWFUpload.UPLOAD_ERROR.UPLOAD_LIMIT_EXCEEDED:
					wxcalert('The upload limit has been reached (' + errorMsg + ').');
