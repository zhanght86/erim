...
public class ManagementDetailController {
	...
	public String sametown(ModelMap model ,@ModelAttribute("managementDetail") ManagementDetailBean bean) throws ErimException {
    ...
    public String scheduledPage(ModelMap model,Integer id) throws ErimException {
    	...
    	//根据主键查询实体
    	model.addAttribute("managementDetail", managementService.selectManagement(model,id));
