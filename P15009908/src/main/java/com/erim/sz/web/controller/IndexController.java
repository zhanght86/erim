...
public class IndexController {
    ...
    public String index(ModelMap model, HttpServletRequest request) {
    	//model.addAttribute("funcs", this.cusSystemFuncService.selectAll());
    	if(null != SecurityUtils.getSubject().getSession().getAttribute("userRoleId")){
    		this.cusSystemRoleFuncService.selectFuncByRoleId(SecurityUtils.getSubject().getSession().getAttribute("userRoleId").toString(),model,request);
    		return "index";
    	}
        return this.root();
    }
     ...
     * @return String    返回类型 
     * @author maoxian
     * @date 2015年12月18日 下午10:44:46 
     * @throws
     */
    @RequestMapping(value = "/buiness")
    public String buiness(ModelMap model){
    	return "common/buiness";
    }
