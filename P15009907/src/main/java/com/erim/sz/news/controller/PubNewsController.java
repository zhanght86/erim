...
public class PubNewsController {
	 ...
	 * @描述: 是否审核
	 * @作者: （李庆）
	 * @创建时间: 2015年12月18日 下午4:29:32
	 * @param bean
	 * @param map
	 * @return
	 * @throws ErimException
	 */
	@RequestMapping(value="/pub/news/newisdel")
	public String updateIsShow(PubNewsBean bean, ModelMap map) throws ErimException {
		this.pubNewsService.newisdel(bean);
   	    bean =new PubNewsBean();
     	return this.showPubNewsPageList(map, bean);
	}
}
