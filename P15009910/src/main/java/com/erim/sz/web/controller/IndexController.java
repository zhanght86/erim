...
public class IndexController {
    ...
    public String index(ModelMap model, HttpServletRequest request) {
    	//model.addAttribute("funcs", this.yjSystemFuncService.selectAll());
    	if(null != SecurityUtils.getSubject().getSession().getAttribute("userRoleId")){
    		this.yjSystemRoleFuncService.selectFuncByRoleId(SecurityUtils.getSubject().getSession().getAttribute("userRoleId").toString(),model);
    		return "index";
    	}
        return this.root();
    }
