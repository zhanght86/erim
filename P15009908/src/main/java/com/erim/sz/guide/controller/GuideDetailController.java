...
public class GuideDetailController {
    ...
    public String sametown(ModelMap model, @ModelAttribute("guideDetail") GuideDetailBean bean) throws ErimException {
     ...
     * @描述: 更改是否上架状态
     * @作者: 宁晓强
     * @创建时间: 2015年12月15日 下午3:37:47
     * @param bean
     * @param model
     * @return 返回类型 1删除成功，0 删除失败
     * @throws ErimException
     */
    ...
    public String delete(GuideDetailBean bean,ModelMap model) throws ErimException {
    	...
    	// 执行更改
    	guideService.updateStatus(model, bean);
    	// 查询列表
