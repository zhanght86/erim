...
$(".djj_ctl .djj_ctlr .djj_ctlm a").live("click",function(){
	if($(this).text()=="添加代金券"){
        ...
        $(this).parent().parent().parent().after("<div class='djj_ctl'>" + 
			...
			"<div class='djj_ctlr'>" + 
				"<div class='djj_ctlm'>" + 
					"<input type='text' class='validate[required,zytom[integer],min[1],max[100000],funcCall[comparison2]]' name='cvpPriceTotal'><span>元</span><span style='color:red;margin-left:69px;margin-top:-27px;'>*</span>" + 
				"</div>" + 
				"<span>同业价:</span>" + 
				"<div class='djj_ctlm'>" + 
					"<input type='text' class='validate[required,zytom[integer],min[1],max[100000]]' name='cvpPriceTown'><span>元</span><span style='color:red;margin-left:69px;margin-top:-27px;'>*</span>" + 
				"</div>" + 
				"<span>批发价:</span>" + 
				"<div class='djj_ctlm'>" + 
					"<input type='text' class='validate[required,zytom[integer],min[1],max[100000],funcCall[comparison1]]' name='cvpPriceSale'><span>元</span><span style='color:red;margin-left:69px;margin-top:-27px;'>*</span>" + 
				"</div>" + 
				"<span>零售价:</span>" + 
				"<div class='djj_ctlm'>" + 
					"<input type='text' class='validate[required,zytom[integer],min[1],max[100000],funcCall[comparison]]' name='cvpPriceRetail'><span>元</span><span style='color:red;margin-left:69px;margin-top:-27px;'>*</span>" + 
