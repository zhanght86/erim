...
import com.erim.sz.common.bean.PlaneticketDetailBean;
 ...
 public class PlaneticketDetailDao extends BaseDao {
	  ...
	  * @描述: 飞机票数据列表
	  * @作者: 宁晓强
	  * @创建时间: 2015年12月1日 下午8:40:45
	  * @param baseBean
	  * @param model
	  * @return
	  */
	 public List<PlaneticketDetailBean> selectPageTown(BaseBean baseBean, ModelMap model){
		 return getSqlSession().selectList("planeticketdetail.selectPageTown", baseBean, 
	 ...
	 * @throws
	 */
    public void updatePlaneticket1(PlaneticketDetailBean bean){
    	getSqlSession().update("planeticketdetail.update1", bean);
    }
}
