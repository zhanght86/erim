...
public class CafeteriaPackageController {
    ...
    /**
	 * @Description:   特色餐套餐列表页
     * @param          model
	 * @return         String 返回类型
     */
	@RequestMapping(value = "/cafeteria/package/list")
	public String showList(ModelMap model,@ModelAttribute("cafeteriaPackage") CafeteriaPackageBean cafeteriaPackageBean) {
		
		cafeteriaPackageService.showCafeteriaPackage(model, cafeteriaPackageBean);
