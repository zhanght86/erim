    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        ...
        if (SecurityUtils.getSubject().isAuthenticated()) {
            ...
            if (SecurityUtils.getSubject().getSession().getAttribute("userName") == null) {
                ...
                // 查询客户其他信息信息
            	ZySystemUserBean bean = userDao.selectUserByLoginname(SecurityUtils.getSubject().getPrincipal().toString());
	            ...
	            //获取角色名称
	            SecurityUtils.getSubject().getSession().setAttribute("userRoleName", bean.getZyRoleId());
            	...
            	if(!uri.contains("/index;")){
            		...
            		//是否包含权限
                	boolean isHaveAuthorityByRoleUrl = this.zySystemRescourceService.isHavaAuthorityByRoleUrl(uri);
