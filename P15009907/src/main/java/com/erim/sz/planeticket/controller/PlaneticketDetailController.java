...
public class PlaneticketDetailController {
    ...
    public String sametown(ModelMap model, @ModelAttribute("planeticketDetail") PlaneticketDetailBean planeticketDetailBean) throws ErimException {
    	this.planeticketService.showPlaneticketTown(model, planeticketDetailBean);
