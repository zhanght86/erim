...
(function (Highcharts) {
	...
	var MapAreaPoint = Highcharts.extendClass(Point, {
		...
		/**
		 * Zytom animation for tweening out the colors. Animation reduces blinking when hovering
		 * over islands and coast lines. We run a zytom implementation of animation becuase we
