...
$(function () {
	...
	$("#newline1  .carinfo_ctblr_a .a_button").die("click").live("click",function(){
		...
		if(stu_num>6){
	   	...
	   	if($(this).text()=="+") {
	   		$(this).parent().parent().append('<div class="carinfo_ctblr_a" style="margin-top:15px;float:right;width:227px;"><div class="doadmin_toplbra" style="width:130px;"><input type="text" style="width:150px;"  name="gdlDestinationCountry" class="validate[maxSize[20]] autoquerycountry" onfozy="autoquery();"></div><a class="a_button" style="float:right;"  href="javascript:void(0)">-</a></div>');
	   	}
	});
