...
public class PubSametownController {
	...
	public String setsametown(@ModelAttribute("ntype") String ntype,@ModelAttribute("cid")Integer cid,
			@ModelAttribute("companyDetail") CompanyDetailBean bean, ModelMap model) {
