...
import com.erim.sz.web.dao.TmSystemRegionDao;
...
public class TmSystemRegionService {
    ...
    public String getValueByCodeNoAndKey(String codeNo, String key) {
     ...
     public List<TmSystemRegionBean> getSystemCodeListForProvince(){
    	 return regionDao.getSystemRegionForProvince();
     }
     /**
      * 根据RegionName查询城市code
      */
     public TmSystemRegionBean getSystemRegionByRegionName(TmSystemRegionBean bean) {
 		List<TmSystemRegionBean> beanList = this.regionDao.getSystemRegionByRegionName(bean);
