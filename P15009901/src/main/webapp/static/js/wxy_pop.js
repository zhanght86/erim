/**
 * Created by 王笑洋 on 2015/11/5.
 */
$(document).ready(function(){
    /*wxy起价说明*/
    $(".wxy_a_hide").hide();
    $(".wxy_a_show").mouseover(function(){
        $(".wxy_a_hide").show();
    });
    $(".wxy_a_hide").mouseover(function(){
        $(".wxy_a_hide").show();
    });
    $(".wxy_a_show").mouseout(function(){
        $(".wxy_a_hide").hide();
    });
    $(".wxy_a_hide").mouseout(function(){
        $(".wxy_a_hide").hide();
    });
...
function Focus() {
    ...
    function changePic() {
        ...
        if (iActive == 0) {
            doMove(bytag('ul', oBtn)[0], 'top', 0);
        } else if (iActive >= oPicLis.length - 2) {
            doMove(bytag('ul', oBtn)[0], 'top', -(oPicLis.length - 3) * (oBtnLis[0].offsetHeight + 14));
        } else {
            doMove(bytag('ul', oBtn)[0], 'top', -(iActive - 1) * (oBtnLis[0].offsetHeight + 14));
        }
    };
    function autoplay() {
