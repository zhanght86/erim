//  添加出发站点
$(".div_rbox .div_right .a_add").live('click', function() {
    ...
    if ($(this).text() == "+") {
        $(this).parent().before('<div class="div_right"><input type="text" name="attdStartStation" class="room_num"><a href="javascript:void(0)" class="a_add bg_ccc">-</a></div>');
    }
});
$(".nation_box").hide();
$(".inter_box").hide();
