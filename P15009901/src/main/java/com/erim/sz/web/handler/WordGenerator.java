...
public class WordGenerator {
	...
	static {
		...
		try {
			allTemplates.put("resume", configuration.getTemplate("groundtrip.ftl"));
			allTemplates.put("line", configuration.getTemplate("linetrip.ftl"));
		} catch (IOException e) {
			e.printStackTrace();
