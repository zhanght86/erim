...
public class CompanyRegeditController {
	...
	public Integer regeditSaveInfo(CompanyDetailBean bean, CompanyContactPersonBean personBean, 
	...
	public Integer regeditSaveUser(ModelMap map, SellSystemUserBean bean) {
	...
	public String regeditSuccessPage(ModelMap map, SellSystemUserBean bean, Integer cpyId) {
	...
	public @ResponseBody Integer ajaxCheckLoginName(String loginanme){
		return sellSystemUserService.checkLoginName(loginanme);
	}
