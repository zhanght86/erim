...
win.HighchartsAdapter = {
	...
	extendWithEvents: function (el) {
		// if the addEvent method is not defined, el is a zytom Highcharts object
		// like series or point
		if (!el.addEvent) {
			if (el.nodeName) {
				el = $(el); // a dynamically generated node
			} else {
				$extend(el, new Events()); // a zytom object
			}
		}
	},
	 ...
	 * @param {Object} el HTML element or zytom object
	...
	addEvent: function (el, type, fn) {
		if (typeof type === 'string') { // chart broke due to el being string, type function
			...
			if (type === 'unload') { // Moo self destructs before zytom unload events
				type = 'beforeunload';
			}
