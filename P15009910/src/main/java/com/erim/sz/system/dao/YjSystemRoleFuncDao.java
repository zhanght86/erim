...
/**
 * 
 * @ClassName: YjSystemRoleFuncDao 
 * @Description: 角色权限表
 * @author maoxian
 * @date 2015年8月2日 上午11:25:38
 */
@Repository("yjSystemRoleFuncDao")
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class YjSystemRoleFuncDao extends BaseDao {
	...
	public void insertList(List<YjSystemRoleFuncBean> yjSystemRoleFuncBeans){
		this.getSqlSession().insert("yjsystemrolefunc.insertList", yjSystemRoleFuncBeans);
	}
	...
	public List<YjSystemRoleFuncBean> selectRoleFuncByRoleId(String roleid){
		return this.getSqlSession().selectList("yjsystemrolefunc.selectRoleFuncByRoleId", roleid);
	}
	/**
	 * 
	...
	public void deleteByRoleId(String zxRoleId){
		this.getSqlSession().delete("yjsystemrolefunc.deleteByRoleCode", zxRoleId);
	}
}